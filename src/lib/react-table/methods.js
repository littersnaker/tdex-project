...
export default Base =>
  class extends Base {
    ...
    getDataModel (newState, noReset=false) {
      const {
        columns,
        pivotBy = [],
        data,
      ...
      if (!noReset){
          ...
          dmState.headerGroups = headerGroups;
          dmState.hasHeaderGroups = hasHeaderGroups;
          dmState.allVisibleColumns = allVisibleColumns;
          dmState.allDecoratedColumns = allDecoratedColumns;
      }else{
          allDecoratedColumns = newState.allDecoratedColumns;
          allVisibleColumns = newState.allVisibleColumns;
      }
        ...
        resolvedData = data.map((d, i) => accessRow(d, i))
      ...
      dmState.resolvedData = resolvedData;
      dmState.noReset = noReset;
    ...
    checkDataEqual(newData, oldData){
      return this.props.equalData(newData, oldData);
    }
    ...
    // //     const newMinRows = data.length;
    // //     const newState = {data, minRows:newMinRows, pageSize:newMinRows};
    // //     const newResolvedState = this.getResolvedState({}, old newState);
    // //     if (newResolvedState.sortData){
    // //         Object.assign(newResolvedState, this.getSortedData(newResolvedState))
    // //     }
    // //     this.setStateWithData(newResolvedState);
    // }
